...
export default function SearchPage({ properties, favorites, addFavorites, removeFavorite, clearFavorites }) {
    ...
    const filteredProperties = useMemo(() => {
        return properties.filter((property) => {
            ...
            if (searchFilters.postcodeArea) {
                if (!property.location.toLowerCase().startsWith(searchFilters.postcodeArea.toLocaleLowerCase()))
                    return false;
            }
            return true;
        });
